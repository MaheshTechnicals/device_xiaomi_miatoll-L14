...
git clone https://github.com/SwapnilVicky/device_xiaomi_sm6250-common -b lineage-21.0 device/xiaomi/sm6250-common
...
git clone --depth=1 https://github.com/SwapnilVicky/namaste_xiaomi_miatoll -b lineage-21.0 kernel/xiaomi/sm6250
